...
TEST_F(FailureTest, CrashTest)
{
	...
	ubuntu::app_launch::Registry::appFailed(registry).connect([&last_observer](std::shared_ptr<ubuntu::app_launch::Application> app, std::shared_ptr<ubuntu::app_launch::Application::Instance> instance, ubuntu::app_launch::Registry::FailureType type) {
