...
TEST_F(LibUAL, StartApplication)
{
	...
	EXPECT_EQ(guint(1), len);

	EXPECT_STREQ("Start", calls->name);
	EXPECT_EQ(guint(2), g_variant_n_children(calls->params));
...
TEST_F(LibUAL, ApplicationList)
{
	...
	ASSERT_EQ(guint(3), g_strv_length(apps));
...
TEST_F(LibUAL, HelperList)
{
	...
	EXPECT_EQ(guint(0), g_strv_length(blanktype));
	...
	EXPECT_EQ(guint(2), g_strv_length(goodtype));
...
TEST_F(LibUAL, HelperInstanceList)
{
	...
	EXPECT_NE(nullptr, goodtype);
	EXPECT_EQ(guint(1), g_strv_length(goodtype));
...
TEST_F(LibUAL, DISABLED_PauseResume)
{
	...
	EXPECT_EVENTUALLY_EQ(guint(1), paused_count);
	EXPECT_EQ(guint(0), datacnt);
	...
	EXPECT_EVENTUALLY_EQ(guint(1), resumed_count);
	EXPECT_NE(guint(0), datacnt);
	...
	EXPECT_EQ(guint(1), resumed_count);
