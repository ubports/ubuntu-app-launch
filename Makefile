default: desktop-exec lsapp zg-report-app application.conf application-click.conf application-legacy.conf upstart-app-launch-desktop.hook
	@echo "Building"
...
install: application-legacy.conf application-legacy.conf desktop-exec upstart-app-launch-desktop.hook
